...
public class ProductEditViewModel extends ViewModel {
  ...
  private void onGetProductSuccess(Result<Product> result) {
    if (result instanceof Result.Success<Product> success) {
      ...
      productUiModel.setValue(ProductUiModelMapper.fromDomain(Objects.requireNonNull(product)));
  ...
  public void validateName() {
    setErrors(
        errorMap -> {
          String error =
              validator.validateName(Objects.requireNonNull(productUiModel.getValue()).getName());
          if (error.isBlank()) {
  ...
  public void validatePurchasePrice() {
    setErrors(
        errorMap -> {
          ...
          double sellingPrice = Objects.requireNonNull(productUiModel.getValue()).getSellingPrice();
  ...
  /**
   * Validates the product description. This method updates the validation state with the result of
   * the validation.
   */
        ...
        errorMap -> {
          String error =
              validator.validateDescription(
                  Objects.requireNonNull(productUiModel.getValue()).getDescription());
          if (error.isBlank()) {
  ...
  public void validateNote() {
    setErrors(
        errorMap -> {
          String error =
              validator.validateNote(Objects.requireNonNull(productUiModel.getValue()).getNote());
          if (error.isBlank()) {
  ...
  public void validateBrand() {
    setErrors(
        errorMap -> {
          String error =
              validator.validateBrand(Objects.requireNonNull(productUiModel.getValue()).getBrand());
          if (error.isBlank()) {
