package com.optlab.banhangso.features.main.customer;
...
public final class CustomerValidator extends BaseValidator {

  private final HashMap<String, List<ValidationRule<String>>> rules = new HashMap<>();
