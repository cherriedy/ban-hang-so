...
class BrandSelectionAdapter :
  ...
  inner class ViewHolder(private val binding: ListItemBrandSelectionBinding) :
    ...
    fun bind(brand: BrandUiModel, isSelected: Boolean) {
      binding.brand = brand
  ...
  private class DiffCallback : DiffUtil.ItemCallback<BrandUiModel>() {
    override fun areItemsTheSame(oldItem: BrandUiModel, newItem: BrandUiModel): Boolean {
      return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(oldItem: BrandUiModel, newItem: BrandUiModel): Boolean {
