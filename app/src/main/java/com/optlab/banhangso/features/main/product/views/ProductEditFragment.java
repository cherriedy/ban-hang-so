...
public class ProductEditFragment extends Fragment {
  ...
  private void showExitConfirmationDialog() {
    new ExitConfirmationDialog().show(getParentFragmentManager(), this.getClass().getSimpleName());
  }
  ...
  private void initViewModels() {
    ...
    NavBackStackEntry productEditBackEntry =
        NavHostFragment.findNavController(this).getBackStackEntry(R.id.nav_graph_product_edit);
    sharedViewModel =
  ...
  public void onBrandSelectionClick(View view) {
    ...
    String brandId = productUiModel.getBrand() == null ? null : productUiModel.getBrand().getId();
