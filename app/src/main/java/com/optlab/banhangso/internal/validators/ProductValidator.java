...
public final class ProductValidator {
  ...
  public String validatePurchasePrice(@NonNull Double purchasePrice, @NonNull Double sellingPrice) {
  ...
  public String validateDiscountPrice(@NonNull Double discountPrice, @NonNull Double sellingPrice) {
    if (discountPrice < 0) {
      return context.getString(R.string.alert_product_price_invalid);
