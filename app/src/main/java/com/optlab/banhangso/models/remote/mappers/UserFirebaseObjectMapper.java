...
public class UserFirebaseObjectMapper {
  ...
  @NonNull public static User toDomain(@NonNull UserFirebaseObject userFirebaseObject) {
    User user = new User();
  ...
  @NonNull public static UserFirebaseObject fromDomain(@NonNull User user) {
  ...
  @NonNull private static User.Store toUserStoreDomain(@NonNull UserFirebaseObject.Store firebaseUserStore) {
  ...
  @NonNull private static UserFirebaseObject.Store fromUserStoreDomain(@NonNull User.Store userStore) {
