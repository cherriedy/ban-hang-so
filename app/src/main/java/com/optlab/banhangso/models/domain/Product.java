...
public class Product {
    public Product(String id, String barcode, Category category, Brand brand, String name, double purchasePrice, double sellingPrice, String avatarUrl, int stockQuantity, String description, boolean status, double discountPrice, String note, Date createdAt, Date updatedAt) {
        this.id = id;
    ...
    public String toString() {
        return "Product(id=" + this.getId() + ", barcode=" + this.getBarcode() + ", category=" + this.getCategory() + ", brand=" + this.getBrand() + ", name=" + this.getName() + ", purchasePrice=" + this.getPurchasePrice() + ", sellingPrice=" + this.getSellingPrice() + ", avatarUrl=" + this.getAvatarUrl() + ", stockQuantity=" + this.getStockQuantity() + ", description=" + this.getDescription() + ", status=" + this.isStatus() + ", discountPrice=" + this.getDiscountPrice() + ", note=" + this.getNote() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ")";
    }
    ...
    public static class ProductBuilder {
        ...
        public Product build() {
            return new Product(this.id, this.barcode, this.category, this.brand, this.name, this.purchasePrice, this.sellingPrice, this.avatarUrl, this.stockQuantity, this.description, this.status, this.discountPrice, this.note, this.createdAt, this.updatedAt);
        }

        public String toString() {
            return "Product.ProductBuilder(id=" + this.id + ", barcode=" + this.barcode + ", category=" + this.category + ", brand=" + this.brand + ", name=" + this.name + ", purchasePrice=" + this.purchasePrice + ", sellingPrice=" + this.sellingPrice + ", avatarUrl=" + this.avatarUrl + ", stockQuantity=" + this.stockQuantity + ", description=" + this.description + ", status=" + this.status + ", discountPrice=" + this.discountPrice + ", note=" + this.note + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ")";
        }
    }
}
