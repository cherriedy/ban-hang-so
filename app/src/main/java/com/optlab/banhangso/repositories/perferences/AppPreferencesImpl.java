...
public class AppPreferencesImpl implements AppPreferences {
    ...
    @Override
    public void registerPreferencesChangeListener(SharedPreferences.OnSharedPreferenceChangeListener listener) {
    ...
    public RoleStore getStore() {
        ...
        return gson.fromJson(storeJson, new TypeToken<RoleStore>() {}.getType());
    }
