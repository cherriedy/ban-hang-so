...
class CategoryRepositoryImpl
    ...
    constructor(
        ...
        override fun getCategories(): Flowable<PagingData<Category>> =
            Pager(pagingConfig) { CategoryPagingSource(preferencesRepositoryKt, categoryService) }
                .flowable
        ...
        override fun searchCategories(query: String): Flowable<PagingData<Category>> =
            Pager(pagingConfig) {
                CategorySearchPagingSource(preferencesRepositoryKt, categoryService, query)
            }
                .flowable
                .map { pagingData -> pagingData.map(CategoryFirebaseObjectMapper::toDomain) }
